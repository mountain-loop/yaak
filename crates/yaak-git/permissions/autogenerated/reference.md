...
`yaak-git:allow-add-credential`

</td>
<td>

Enables the add_credential command without any pre-configured scope.
...
`yaak-git:deny-add-credential`

</td>
<td>

Denies the add_credential command without any pre-configured scope.
...
`yaak-git:allow-remotes`

</td>
<td>

Enables the remotes command without any pre-configured scope.
...
`yaak-git:deny-remotes`

</td>
<td>

Denies the remotes command without any pre-configured scope.
...
`yaak-git:allow-rm-remote`

</td>
<td>

Enables the rm_remote command without any pre-configured scope.
...
`yaak-git:deny-rm-remote`

</td>
<td>

Denies the rm_remote command without any pre-configured scope.
