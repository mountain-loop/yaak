...
import type { AnyModel, GraphQlIntrospection, GrpcEvent, HttpRequest, HttpRequestHeader, HttpResponse, HttpResponseEvent, ImportSource, ModelVersion, ModelVersionReason, Plugin, RequestVersionComparison, Settings, WebsocketConnection, WebsocketEvent, WorkspaceMeta } from "./gen_models";
...
export type ModelsRequestVersionReq = { versionId: string, };

export type ModelsRestoreRequestVersionReq = { versionId: string, };

export type ModelsSnapshotRequestReq = { requestId: string, reason: ModelVersionReason, };
