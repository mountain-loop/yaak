...
import type { JsonPathChildren } from "./gen_jsonpath";
...
export type CmdDetectImportSourceReq = { filePath?: string, url?: string, };
...
export type CmdHttpResponseJsonChildrenReq = { responseId: string, parent: string, };

export type CmdImportDataReq = { filePaths: Array<string>, urls: Array<string>, destination: ImportDestination, };
...
export type CmdPreviewHttpAssertionsReq = { responseId: string, assertions: HttpAssertions, };
...
export type CmdValidateHttpAssertionsReq = { assertions: HttpAssertions, };
