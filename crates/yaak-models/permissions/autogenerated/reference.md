...
`yaak-models:allow-get-graphql-introspection`

</td>
<td>

Enables the get_graphql_introspection command without any pre-configured scope.
...
`yaak-models:deny-get-graphql-introspection`

</td>
<td>

Denies the get_graphql_introspection command without any pre-configured scope.
...
`yaak-models:allow-upsert-graphql-introspection`

</td>
<td>

Enables the upsert_graphql_introspection command without any pre-configured scope.
...
`yaak-models:deny-upsert-graphql-introspection`

</td>
<td>

Denies the upsert_graphql_introspection command without any pre-configured scope.
