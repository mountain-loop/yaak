...
export type PromptSelectRequest = { id: string, title: string, label: string, description?: string, defaultValue?: string, 
/**
...
export type PromptSelectResponse = { value: string | null, };
