...
export type GetWorkspaceMetaRequest = Record<string, never>;

export type GetWorkspaceMetaResponse = { id: string, settingSyncDir: string | null, };
...
export type ListWorkspacesResponse = { workspaces: Array<WorkspaceInfo>, };
