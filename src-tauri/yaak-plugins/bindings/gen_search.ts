...
export type PluginMetadata = { version: string, name: string, displayName: string | null, description: string | null, homepageUrl: string | null, repositoryUrl: string | null, };
