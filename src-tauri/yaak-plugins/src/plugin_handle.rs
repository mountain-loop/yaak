...
use crate::events::{BootResponse, InternalEvent, InternalEventPayload, PluginEventContext};
...
impl PluginHandle {
    ...
    pub async fn terminate(&self, window_context: &PluginEventContext) -> Result<()> {
