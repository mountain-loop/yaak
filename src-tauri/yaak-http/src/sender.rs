...
pub struct HttpResponse {
    ...
    /// Response headers (Vec to support duplicate headers like Set-Cookie)
    pub headers: Vec<(String, String)>,
    /// Request headers (Vec to support duplicate headers)
...
impl HttpSender for ReqwestSender {
    async fn send(
        ...
        // Extract headers (use Vec to preserve duplicate headers like Set-Cookie)
