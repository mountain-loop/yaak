            ...
            {receivedCookies.map((cookie, i) => (
              ...
              <div key={i} className="flex flex-col gap-1">
                <div className="font-semibold text-text flex items-center gap-2">
                  <span className={cookie.isDeleted ? 'line-through opacity-60' : ''}>
                ...
                <KeyValueRows>
                  {cookie.domain && (
                    <KeyValueRow labelColor="info" label="Domain">
                      {cookie.domain}
                    </KeyValueRow>
                  )}
                  {cookie.path && (
                    <KeyValueRow labelColor="info" label="Path">
                      {cookie.path}
                    </KeyValueRow>
                  )}
                  {cookie.expires && (
                    <KeyValueRow labelColor="info" label="Expires">
                      {cookie.expires}
                    </KeyValueRow>
                  )}
                  {cookie.maxAge && (
                    <KeyValueRow labelColor="info" label="Max-Age">
                      {cookie.maxAge}
                    </KeyValueRow>
                  )}
                  {cookie.secure && (
                    <KeyValueRow labelColor="info" label="Secure">
                      true
                    </KeyValueRow>
                  )}
                  {cookie.httpOnly && (
                    <KeyValueRow labelColor="info" label="HttpOnly">
                      true
                    </KeyValueRow>
                  )}
                  {cookie.sameSite && (
                    <KeyValueRow labelColor="info" label="SameSite">
                      {cookie.sameSite}
                    </KeyValueRow>
                  )}
                </KeyValueRows>
